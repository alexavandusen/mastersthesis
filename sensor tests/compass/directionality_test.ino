...
void setup() {
  ...
  compass.init();
  // Before you ever read the compass, initialize like this:
  calibrationData[0][0] = INT16_MAX;  // xMin
  calibrationData[0][1] = INT16_MIN;  // xMax
  calibrationData[1][0] = INT16_MAX;  // yMin
  calibrationData[1][1] = INT16_MIN;  // yMax
  calibrationData[2][0] = INT16_MAX;  // zMin
  calibrationData[2][1] = INT16_MIN;  // zMax
